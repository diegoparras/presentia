                ...
                <div className="relative z-10 px-8 sm:px-12 lg:px-20 pt-14 py-12 flex-1 flex flex-col justify-center h-full">
                    <div className="text-center space-y-8 max-w-4xl mx-auto">
                        ...
                        <div className="space-y-4">
                            ...
                            {/* Purple accent line */}
                            <div style={{ background: "var(--primary-color,#e25a4e)" }} className="w-20 h-1 bg-purple-400 mx-auto"></div>
                        </div>
                        ...
                        <div className="space-y-6">
                            ...
                            <div className="flex justify-center">
                                <svg
                                    className="w-12 h-12 text-purple-300 opacity-80" style={{ color: "var(--primary-color,#e25a4e)" }}
                                    fill="currentColor"
                                    viewBox="0 0 24 24"
                                >
                            ...
                            <div className="flex justify-center items-center space-x-4">
                                <div style={{ background: "var(--primary-color,#e25a4e)" }} className="w-16 h-px bg-purple-300"></div>
