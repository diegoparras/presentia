...
import CodeSlide12FullCodeBlock, {
  Schema as CodeFullCodeBlockSchema,
  slideLayoutId as CodeFullCodeBlockId,
  slideLayoutName as CodeFullCodeBlockName,
  slideLayoutDescription as CodeFullCodeBlockDesc,
} from "./Code/FullCodeBlockSlide";
import CodeSlide13CodeDiffComparison, {
  Schema as CodeDiffComparisonSchema,
  slideLayoutId as CodeDiffComparisonId,
  slideLayoutName as CodeDiffComparisonName,
  slideLayoutDescription as CodeDiffComparisonDesc,
} from "./Code/CodeDiffComparisonSlide";
import CodeSlide14TerminalCommand, {
  Schema as CodeTerminalCommandSchema,
  slideLayoutId as CodeTerminalCommandId,
  slideLayoutName as CodeTerminalCommandName,
  slideLayoutDescription as CodeTerminalCommandDesc,
} from "./Code/TerminalCommandSlide";
import CodeSlide15FileTreeStructure, {
  Schema as CodeFileTreeStructureSchema,
  slideLayoutId as CodeFileTreeStructureId,
  slideLayoutName as CodeFileTreeStructureName,
  slideLayoutDescription as CodeFileTreeStructureDesc,
} from "./Code/FileTreeStructureSlide";
import CodeSlide16CodeOutput, {
  Schema as CodeOutputSchema,
  slideLayoutId as CodeOutputId,
  slideLayoutName as CodeOutputName,
  slideLayoutDescription as CodeOutputDesc,
} from "./Code/CodeOutputSlide";
...
import EducationLearningOutcomesSlide, {
  Schema as EduLearningOutcomesSchema,
  slideLayoutId as EduLearningOutcomesId,
  slideLayoutName as EduLearningOutcomesName,
  slideLayoutDescription as EduLearningOutcomesDesc,
} from "./Education/EducationLearningOutcomesSlide";
import EducationCurriculumStructureSlide, {
  Schema as EduCurriculumStructureSchema,
  slideLayoutId as EduCurriculumStructureId,
  slideLayoutName as EduCurriculumStructureName,
  slideLayoutDescription as EduCurriculumStructureDesc,
} from "./Education/EducationCurriculumStructureSlide";
import EducationLessonPlanSlide, {
  Schema as EduLessonPlanSchema,
  slideLayoutId as EduLessonPlanId,
  slideLayoutName as EduLessonPlanName,
  slideLayoutDescription as EduLessonPlanDesc,
} from "./Education/EducationLessonPlanSlide";
import EducationAssessmentRubricSlide, {
  Schema as EduAssessmentRubricSchema,
  slideLayoutId as EduAssessmentRubricId,
  slideLayoutName as EduAssessmentRubricName,
  slideLayoutDescription as EduAssessmentRubricDesc,
} from "./Education/EducationAssessmentRubricSlide";
import EducationQAContactSlide, {
  Schema as EduQAContactSchema,
  slideLayoutId as EduQAContactId,
  slideLayoutName as EduQAContactName,
  slideLayoutDescription as EduQAContactDesc,
} from "./Education/EducationQAContactSlide";
...
import FeatureHighlightsSlide, {
  Schema as PoFeatureHighlightsSchema,
  slideLayoutId as PoFeatureHighlightsId,
  slideLayoutName as PoFeatureHighlightsName,
  slideLayoutDescription as PoFeatureHighlightsDesc,
} from "./ProductOverview/FeatureHighlightsSlide";
...
import NextStepsSlide, {
  Schema as PoNextStepsSchema,
  slideLayoutId as PoNextStepsId,
  slideLayoutName as PoNextStepsName,
  slideLayoutDescription as PoNextStepsDesc,
} from "./ProductOverview/NextStepsSlide";
...
import ProblemSolutionSlide, {
  Schema as PoProblemSolutionSchema,
  slideLayoutId as PoProblemSolutionId,
  slideLayoutName as PoProblemSolutionName,
  slideLayoutDescription as PoProblemSolutionDesc,
} from "./ProductOverview/ProblemSolutionSlide";
...
import ProductRoadmapSlide, {
  Schema as PoProductRoadmapSchema,
  slideLayoutId as PoProductRoadmapId,
  slideLayoutName as PoProductRoadmapName,
  slideLayoutDescription as PoProductRoadmapDesc,
} from "./ProductOverview/ProductRoadmapSlide";
...
import TargetAudienceSlide, {
  Schema as PoTargetAudienceSchema,
  slideLayoutId as PoTargetAudienceId,
  slideLayoutName as PoTargetAudienceName,
  slideLayoutDescription as PoTargetAudienceDesc,
} from "./ProductOverview/TargetAudienceSlide";
import UseCasesSlide, {
  Schema as PoUseCasesSchema,
  slideLayoutId as PoUseCasesId,
  slideLayoutName as PoUseCasesName,
  slideLayoutDescription as PoUseCasesDesc,
} from "./ProductOverview/UseCasesSlide";
...
import ReportSectionIndexSlide, {
  Schema as RepSectionsSchema,
  slideLayoutId as RepSectionsId,
  slideLayoutName as RepSectionsName,
  slideLayoutDescription as RepSectionsDesc,
} from "./Report/ReportSectionIndexSlide";
import ExecutiveSummarySlide, {
  Schema as RepExecutiveSummarySchema,
  slideLayoutId as RepExecutiveSummaryId,
  slideLayoutName as RepExecutiveSummaryName,
  slideLayoutDescription as RepExecutiveSummaryDesc,
} from "./Report/ExecutiveSummarySlide";
...
import MethodologySourcesSlide, {
  Schema as RepMethodologySourcesSchema,
  slideLayoutId as RepMethodologySourcesId,
  slideLayoutName as RepMethodologySourcesName,
  slideLayoutDescription as RepMethodologySourcesDesc,
} from "./Report/MethodologySourcesSlide";
...
import KeyFindingsSlide, {
  Schema as RepKeyFindingsSchema,
  slideLayoutId as RepKeyFindingsId,
  slideLayoutName as RepKeyFindingsName,
  slideLayoutDescription as RepKeyFindingsDesc,
} from "./Report/KeyFindingsSlide";
...
import RecommendationsSlide, {
  Schema as RepRecommendationsSchema,
  slideLayoutId as RepRecommendationsId,
  slideLayoutName as RepRecommendationsName,
  slideLayoutDescription as RepRecommendationsDesc,
} from "./Report/RecommendationsSlide";
import RiskLimitationsSlide, {
  Schema as RepRiskLimitationsSchema,
  slideLayoutId as RepRiskLimitationsId,
  slideLayoutName as RepRiskLimitationsName,
  slideLayoutDescription as RepRiskLimitationsDesc,
} from "./Report/RiskLimitationsSlide";
import ActionPlanSlide, {
  Schema as RepActionPlanSchema,
  slideLayoutId as RepActionPlanId,
  slideLayoutName as RepActionPlanName,
  slideLayoutDescription as RepActionPlanDesc,
} from "./Report/ActionPlanSlide";
...
import AppendixNotesSlide, {
  Schema as RepAppendixNotesSchema,
  slideLayoutId as RepAppendixNotesId,
  slideLayoutName as RepAppendixNotesName,
  slideLayoutDescription as RepAppendixNotesDesc,
} from "./Report/AppendixNotesSlide";
import ClosingContactSlide, {
  Schema as RepClosingContactSchema,
  slideLayoutId as RepClosingContactId,
  slideLayoutName as RepClosingContactName,
  slideLayoutDescription as RepClosingContactDesc,
} from "./Report/ClosingContactSlide";
...
import PitchDeckProblemEvidence, {
  Schema as PitchDeckProblemEvidenceSchema,
  slideLayoutId as PitchDeckProblemEvidenceId,
  slideLayoutName as PitchDeckProblemEvidenceName,
  slideLayoutDescription as PitchDeckProblemEvidenceDesc,
} from "./pitch-deck/ProblemEvidenceSlide";
import PitchDeckValueProposition, {
  Schema as PitchDeckValuePropositionSchema,
  slideLayoutId as PitchDeckValuePropositionId,
  slideLayoutName as PitchDeckValuePropositionName,
  slideLayoutDescription as PitchDeckValuePropositionDesc,
} from "./pitch-deck/ValuePropositionSlide";
import PitchDeckProductWorkflow, {
  Schema as PitchDeckProductWorkflowSchema,
  slideLayoutId as PitchDeckProductWorkflowId,
  slideLayoutName as PitchDeckProductWorkflowName,
  slideLayoutDescription as PitchDeckProductWorkflowDesc,
} from "./pitch-deck/ProductWorkflowSlide";
...
import PitchDeckMarketSize, {
  Schema as PitchDeckMarketSizeSchema,
  slideLayoutId as PitchDeckMarketSizeId,
  slideLayoutName as PitchDeckMarketSizeName,
  slideLayoutDescription as PitchDeckMarketSizeDesc,
} from "./pitch-deck/MarketSizeSlide";
import PitchDeckBusinessModel, {
  Schema as PitchDeckBusinessModelSchema,
  slideLayoutId as PitchDeckBusinessModelId,
  slideLayoutName as PitchDeckBusinessModelName,
  slideLayoutDescription as PitchDeckBusinessModelDesc,
} from "./pitch-deck/BusinessModelSlide";
import PitchDeckTractionMetrics, {
  Schema as PitchDeckTractionMetricsSchema,
  slideLayoutId as PitchDeckTractionMetricsId,
  slideLayoutName as PitchDeckTractionMetricsName,
  slideLayoutDescription as PitchDeckTractionMetricsDesc,
} from "./pitch-deck/TractionMetricsSlide";
import PitchDeckGoToMarket, {
  Schema as PitchDeckGoToMarketSchema,
  slideLayoutId as PitchDeckGoToMarketId,
  slideLayoutName as PitchDeckGoToMarketName,
  slideLayoutDescription as PitchDeckGoToMarketDesc,
} from "./pitch-deck/GoToMarketSlide";
import PitchDeckCompetitivePositioning, {
  Schema as PitchDeckCompetitivePositioningSchema,
  slideLayoutId as PitchDeckCompetitivePositioningId,
  slideLayoutName as PitchDeckCompetitivePositioningName,
  slideLayoutDescription as PitchDeckCompetitivePositioningDesc,
} from "./pitch-deck/CompetitivePositioningSlide";
import PitchDeckDefensibility, {
  Schema as PitchDeckDefensibilitySchema,
  slideLayoutId as PitchDeckDefensibilityId,
  slideLayoutName as PitchDeckDefensibilityName,
  slideLayoutDescription as PitchDeckDefensibilityDesc,
} from "./pitch-deck/DefensibilitySlide";
import PitchDeckFinancialProjection, {
  Schema as PitchDeckFinancialProjectionSchema,
  slideLayoutId as PitchDeckFinancialProjectionId,
  slideLayoutName as PitchDeckFinancialProjectionName,
  slideLayoutDescription as PitchDeckFinancialProjectionDesc,
} from "./pitch-deck/FinancialProjectionSlide";
import PitchDeckFundingAsk, {
  Schema as PitchDeckFundingAskSchema,
  slideLayoutId as PitchDeckFundingAskId,
  slideLayoutName as PitchDeckFundingAskName,
  slideLayoutDescription as PitchDeckFundingAskDesc,
} from "./pitch-deck/FundingAskSlide";
import PitchDeckTeamCredentials, {
  Schema as PitchDeckTeamCredentialsSchema,
  slideLayoutId as PitchDeckTeamCredentialsId,
  slideLayoutName as PitchDeckTeamCredentialsName,
  slideLayoutDescription as PitchDeckTeamCredentialsDesc,
} from "./pitch-deck/TeamCredentialsSlide";
import PitchDeckClosingContact, {
  Schema as PitchDeckClosingContactSchema,
  slideLayoutId as PitchDeckClosingContactId,
  slideLayoutName as PitchDeckClosingContactName,
  slideLayoutDescription as PitchDeckClosingContactDesc,
} from "./pitch-deck/ClosingContactSlide";
...
export const codeTemplates: TemplateWithData[] = [
  ...
  createTemplateEntry(
    CodeSlide12FullCodeBlock,
    CodeFullCodeBlockSchema,
    CodeFullCodeBlockId,
    CodeFullCodeBlockName,
    CodeFullCodeBlockDesc,
    "code",
    "FullCodeBlockSlide"
  ),
  createTemplateEntry(
    CodeSlide13CodeDiffComparison,
    CodeDiffComparisonSchema,
    CodeDiffComparisonId,
    CodeDiffComparisonName,
    CodeDiffComparisonDesc,
    "code",
    "CodeDiffComparisonSlide"
  ),
  createTemplateEntry(
    CodeSlide14TerminalCommand,
    CodeTerminalCommandSchema,
    CodeTerminalCommandId,
    CodeTerminalCommandName,
    CodeTerminalCommandDesc,
    "code",
    "TerminalCommandSlide"
  ),
  createTemplateEntry(
    CodeSlide15FileTreeStructure,
    CodeFileTreeStructureSchema,
    CodeFileTreeStructureId,
    CodeFileTreeStructureName,
    CodeFileTreeStructureDesc,
    "code",
    "FileTreeStructureSlide"
  ),
  createTemplateEntry(
    CodeSlide16CodeOutput,
    CodeOutputSchema,
    CodeOutputId,
    CodeOutputName,
    CodeOutputDesc,
...
export const educationTemplates: TemplateWithData[] = [
  ...
  createTemplateEntry(
    EducationLearningOutcomesSlide,
    EduLearningOutcomesSchema,
    EduLearningOutcomesId,
    EduLearningOutcomesName,
    EduLearningOutcomesDesc,
    "education",
    "EducationLearningOutcomesSlide"
  ),
  createTemplateEntry(
    EducationCurriculumStructureSlide,
    EduCurriculumStructureSchema,
    EduCurriculumStructureId,
    EduCurriculumStructureName,
    EduCurriculumStructureDesc,
    "education",
    "EducationCurriculumStructureSlide"
  ),
  createTemplateEntry(
    EducationLessonPlanSlide,
    EduLessonPlanSchema,
    EduLessonPlanId,
    EduLessonPlanName,
    EduLessonPlanDesc,
  ...
  createTemplateEntry(
    EducationAssessmentRubricSlide,
    EduAssessmentRubricSchema,
    EduAssessmentRubricId,
    EduAssessmentRubricName,
    EduAssessmentRubricDesc,
    "education",
    "EducationAssessmentRubricSlide"
  ),
  createTemplateEntry(
    EducationQAContactSlide,
    EduQAContactSchema,
    EduQAContactId,
    EduQAContactName,
    EduQAContactDesc,
...
export const productOverviewTemplates: TemplateWithData[] = [
  ...
  createTemplateEntry(
    ...
    PoProblemSolutionSchema,
    PoProblemSolutionId,
    PoProblemSolutionName,
    PoProblemSolutionDesc,
    "product-overview",
    "ProblemSolutionSlide"
  ),
  ...
  createTemplateEntry(
    TargetAudienceSlide,
    PoTargetAudienceSchema,
    PoTargetAudienceId,
    PoTargetAudienceName,
    PoTargetAudienceDesc,
    "product-overview",
    "TargetAudienceSlide"
  ),
  createTemplateEntry(
  ...
  createTemplateEntry(
    FeatureHighlightsSlide,
    PoFeatureHighlightsSchema,
    PoFeatureHighlightsId,
    PoFeatureHighlightsName,
    PoFeatureHighlightsDesc,
    "product-overview",
    "FeatureHighlightsSlide"
  ),
  createTemplateEntry(
  ...
  createTemplateEntry(
    ProductRoadmapSlide,
    PoProductRoadmapSchema,
    PoProductRoadmapId,
    PoProductRoadmapName,
    PoProductRoadmapDesc,
    "product-overview",
    "ProductRoadmapSlide"
  ),
  createTemplateEntry(
...
export const reportTemplates: TemplateWithData[] = [
  ...
  createTemplateEntry(
    ...
    RepExecutiveSummarySchema,
    RepExecutiveSummaryId,
    RepExecutiveSummaryName,
    RepExecutiveSummaryDesc,
    "report",
    "ExecutiveSummarySlide"
  ),
  createTemplateEntry(
  ...
  createTemplateEntry(
    MethodologySourcesSlide,
    RepMethodologySourcesSchema,
    RepMethodologySourcesId,
    RepMethodologySourcesName,
    RepMethodologySourcesDesc,
    "report",
    "MethodologySourcesSlide"
  ),
  createTemplateEntry(
  ...
  createTemplateEntry(
    ...
    RepRecommendationsSchema,
    RepRecommendationsId,
    RepRecommendationsName,
    RepRecommendationsDesc,
    "report",
    "RecommendationsSlide"
  ),
  createTemplateEntry(
    RiskLimitationsSlide,
    RepRiskLimitationsSchema,
    RepRiskLimitationsId,
    RepRiskLimitationsName,
    RepRiskLimitationsDesc,
    "report",
    "RiskLimitationsSlide"
  ),
  createTemplateEntry(
  ...
  createTemplateEntry(
    AppendixNotesSlide,
    RepAppendixNotesSchema,
    RepAppendixNotesId,
    RepAppendixNotesName,
    RepAppendixNotesDesc,
    "report",
    "AppendixNotesSlide"
  ),
  createTemplateEntry(
    ClosingContactSlide,
    RepClosingContactSchema,
    RepClosingContactId,
    RepClosingContactName,
    RepClosingContactDesc,
    "report",
    "ClosingContactSlide"
  ),
];
...
export const pitchDeckTemplates: TemplateWithData[] = [
  ...
  createTemplateEntry(
    PitchDeckProblemEvidence,
    PitchDeckProblemEvidenceSchema,
    PitchDeckProblemEvidenceId,
    PitchDeckProblemEvidenceName,
    PitchDeckProblemEvidenceDesc,
    "pitch-deck",
    "ProblemEvidenceSlide"
  ),
  createTemplateEntry(
    PitchDeckValueProposition,
    PitchDeckValuePropositionSchema,
    PitchDeckValuePropositionId,
    PitchDeckValuePropositionName,
    PitchDeckValuePropositionDesc,
    "pitch-deck",
    "ValuePropositionSlide"
  ),
  createTemplateEntry(
    PitchDeckProductWorkflow,
    PitchDeckProductWorkflowSchema,
    PitchDeckProductWorkflowId,
    PitchDeckProductWorkflowName,
    PitchDeckProductWorkflowDesc,
    "pitch-deck",
  ...
  createTemplateEntry(
    PitchDeckMarketSize,
    PitchDeckMarketSizeSchema,
    PitchDeckMarketSizeId,
    PitchDeckMarketSizeName,
    PitchDeckMarketSizeDesc,
    "pitch-deck",
    "MarketSizeSlide"
  ),
  createTemplateEntry(
    PitchDeckBusinessModel,
    PitchDeckBusinessModelSchema,
    PitchDeckBusinessModelId,
    PitchDeckBusinessModelName,
    PitchDeckBusinessModelDesc,
    "pitch-deck",
    "BusinessModelSlide"
  ),
  createTemplateEntry(
    PitchDeckTractionMetrics,
    PitchDeckTractionMetricsSchema,
    PitchDeckTractionMetricsId,
    PitchDeckTractionMetricsName,
    PitchDeckTractionMetricsDesc,
    "pitch-deck",
    "TractionMetricsSlide"
  ),
  createTemplateEntry(
    PitchDeckGoToMarket,
    PitchDeckGoToMarketSchema,
    PitchDeckGoToMarketId,
    PitchDeckGoToMarketName,
    PitchDeckGoToMarketDesc,
    "pitch-deck",
    "GoToMarketSlide"
  ),
  createTemplateEntry(
    PitchDeckCompetitivePositioning,
    PitchDeckCompetitivePositioningSchema,
    PitchDeckCompetitivePositioningId,
    PitchDeckCompetitivePositioningName,
    PitchDeckCompetitivePositioningDesc,
    "pitch-deck",
    "CompetitivePositioningSlide"
  ),
  createTemplateEntry(
    PitchDeckDefensibility,
    PitchDeckDefensibilitySchema,
    PitchDeckDefensibilityId,
    PitchDeckDefensibilityName,
    PitchDeckDefensibilityDesc,
    "pitch-deck",
    "DefensibilitySlide"
  ),
  createTemplateEntry(
    PitchDeckFinancialProjection,
    PitchDeckFinancialProjectionSchema,
    PitchDeckFinancialProjectionId,
    PitchDeckFinancialProjectionName,
    PitchDeckFinancialProjectionDesc,
    "pitch-deck",
    "FinancialProjectionSlide"
  ),
  createTemplateEntry(
    PitchDeckFundingAsk,
    PitchDeckFundingAskSchema,
    PitchDeckFundingAskId,
    PitchDeckFundingAskName,
    PitchDeckFundingAskDesc,
    "pitch-deck",
    "FundingAskSlide"
  ),
  createTemplateEntry(
    PitchDeckTeamCredentials,
    PitchDeckTeamCredentialsSchema,
    PitchDeckTeamCredentialsId,
    PitchDeckTeamCredentialsName,
    PitchDeckTeamCredentialsDesc,
    "pitch-deck",
    "TeamCredentialsSlide"
  ),
  createTemplateEntry(
    PitchDeckClosingContact,
    PitchDeckClosingContactSchema,
    PitchDeckClosingContactId,
    PitchDeckClosingContactName,
    PitchDeckClosingContactDesc,
    "pitch-deck",
    "ClosingContactSlide"
  ),
  createTemplateEntry(
