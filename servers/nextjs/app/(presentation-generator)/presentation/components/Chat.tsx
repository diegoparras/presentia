    ...
    <div className={cn("flex h-full w-full flex-col bg-white", "")}>
      <div className="flex items-center justify-between px-4 pt-8">
        <div className="flex items-center gap-2">
          ...
          {isSending && (
            <span className="inline-flex items-center gap-1 rounded-full bg-[#FAEEE3] px-2 py-0.5 text-[10px] font-medium text-[#6941C6]">
                ...
                >
                  <g clipPath="url(#clip0_6216_326)">
                    <path
                      ...
                      stroke={isFollowAgentEnabled ? "#c2571f" : "#000000"}
