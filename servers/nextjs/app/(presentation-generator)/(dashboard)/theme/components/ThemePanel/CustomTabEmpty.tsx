...
const CustomTabEmpty = () => {
    ...
    return (
        <div
            ...
            className='w-[305px] max-w-full rounded-xl border border-[#EDEEEF] cursor-pointer'>
            <div className='relative h-[250px] flex justify-center items-center '>
                ...
                <div className='w-[36px] h-[36px] relative z-[4]  rounded-full bg-[#e25a4e] flex items-center justify-center'
                    style={{
            ...
            <div className='px-5 py-4 bg-white flex items-center gap-4 border-t border-[#EDEEEF]'>
                <div className='bg-[#e25a4e] w-[45px] h-[45px] rounded-lg p-2 flex items-center justify-center'>

                    <Sparkles className='w-6 h-6 text-white' />
                </div>
                <div>
                    <h4 className='text-[#191919] text-sm font-semibold '>{t('lib.themes.buildTheme')}</h4>
                    <p className='flex text-[#808080] text-sm  font-medium items-center gap-2'>{t('lib.themes.fromColors')} <ArrowRight className='w-3 h-3' /> {t('lib.themes.toFonts')} </p>
                </div>
