          ...
          {isFontUploading ? (
            <div className='flex items-center gap-3'>
              <div className='w-10 h-10 rounded-lg bg-[#EBE9FE] flex items-center justify-center'>
                <Loader2 className='w-5 h-5 text-[#a87f16] animate-spin' />
              </div>
              <div className='flex-1'>
                <p className='text-sm font-medium text-[#a87f16]'>Uploading font...</p>
            ...
            <div className='flex items-center gap-3'>
              <div className='w-10 h-10 rounded-lg bg-[#EBE9FE] flex items-center justify-center group-hover:bg-[#DDD8FD] transition-colors'>
                <Plus className='w-5 h-5 text-[#a87f16]' />
              </div>
              <div className='flex-1'>
                <p className='text-sm font-medium text-[#151515]'>Upload Font File</p>
                <p className='text-xs text-[#888]'>.ttf, .otf, .woff, .woff2</p>
              </div>
              <ChevronRight className='w-4 h-4 text-[#999] group-hover:text-[#a87f16] transition-colors' />
            </div>
          )}
        </div>
        <input
    ...
    <div className="space-y-6 px-6 font-syne">
      ...
      <div className='p-1 rounded-[40px] bg-[#F7F6F9] w-fit border border-[#F4F4F4] flex items-center justify-center '>
        <button className='px-5  py-2 text-xs font-medium text-[#3A3A3A] rounded-[70px]'
          ...
          style={{
            background: tab === 'custom' ? 'linear-gradient(270deg, #EFE3C2 2.4%, #F2E8D2 27.88%, #F4DCD3 69.23%, #FDE4C2 100%)' : 'transparent'
          }}
        >Custom</button>
        ...
        <button className='px-5  py-2 text-xs font-medium text-[#3A3A3A] rounded-[70px]'
          ...
          style={{
            background: tab === 'default' ? 'linear-gradient(270deg, #EFE3C2 2.4%, #F2E8D2 27.88%, #F4DCD3 69.23%, #FDE4C2 100%)' : 'transparent'
          }}
        >Built-in</button>
      </div>
      {/* Built-in Themes */}
