...
const HeroTitle = () => {
  ...
  return (
    <div className="flex flex-col items-center justify-center  mb-8 ">
      ...
      <p className="text-xl  font-syne text-[#101323CC]">{t("up.hero.subtitle")}</p>
    </div>
  );
};
