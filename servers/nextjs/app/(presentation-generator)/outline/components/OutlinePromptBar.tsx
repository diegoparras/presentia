    ...
    <section className="w-full font-syne">
      <div className="mb-5 flex flex-col gap-3 xl:flex-row xl:items-center xl:justify-between">
        <div className="flex flex-col gap-3 sm:flex-row sm:flex-wrap sm:items-center">
          <span className="text-sm font-semibold text-[#191919]">{t("up.outline.prompt")}</span>
      ...
      >
        <Textarea
          ...
          placeholder={t("up.outline.promptPh")}
        ...
        <button
          ...
          aria-label={t("up.outline.regenerateAria")}
          title={t("up.outline.regenerateAria")}
          className={cn(
        ...
        >
          {isBusy ? (
            <>
              ...
              <span className="hidden sm:inline">{t("up.outline.regenerating")}</span>
            </>
          ) : (
            <>
              <RefreshCw className="h-4 w-4" />
              <span className="hidden sm:inline">{t("up.outline.regenerate")}</span>
            </>
          )}
        </button>
      </div>
