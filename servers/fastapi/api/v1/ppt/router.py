...
from api.v1.ppt.endpoints.ai_edit import AI_ROUTER
from api.v1.ppt.endpoints.collab import COLLAB_ROUTER
...
API_V1_PPT_ROUTER.include_router(AI_ROUTER)
...
API_V1_PPT_ROUTER.include_router(COLLAB_ROUTER)
